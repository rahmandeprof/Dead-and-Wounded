        ...
        return (
            <div className="w-full max-w-4xl">
                ...
                <div className="bg-slate-800 p-12 rounded-2xl shadow-2xl border border-slate-700 text-center">
                    ...
                    <button
                        onClick={onBack}
                        className="mt-6 px-6 py-3 bg-orange-600 hover:bg-orange-500 text-white font-semibold rounded-lg transition-colors"
                    >
                        Start Playing!
                    </button>
                </div>
    ...
    return (
        <div className="w-full max-w-4xl">
            <div className="flex items-center justify-between mb-8">
                <div>
                    <h2 className="text-3xl font-bold">Game History</h2>
                    <p className="text-slate-400 mt-1">Your recent matches</p>
                </div>
                <button
                    onClick={onBack}
                    className="px-4 py-2 bg-slate-700 hover:bg-slate-600 text-white rounded-lg transition-colors"
